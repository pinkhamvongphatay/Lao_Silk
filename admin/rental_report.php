...
if (!empty($search)) {
    ...
    $whereClause = "WHERE c.username LIKE '%$searchEscaped%' 
                    OR e.username LIKE '%$searchEscaped%' 
                    OR r.id LIKE '%$searchEscaped%'";
}
...
<div class="container mt-4">
    ...
    <table class="table table-bordered">
        ...
        <!-- 🔻 แสดงยอดรวมเฉพาะสถานะ "ຈອງແລ້ວ" -->
        <tr class="table-success fw-bold">
            <td colspan="2" class="text-end">ຍອດລວມການຈອງ (ສະຖານະ: ຈອງແລ້ວ):</td>
